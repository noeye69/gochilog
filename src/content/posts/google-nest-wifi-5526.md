...
pubDatetime: 2020-01-18T16:39:36+09:00
...
前に住んでいたマンションの自宅のネット環境は、マンションの無料の回線をwi-fiで飛ばしていたのですが、無料の回線は遅すぎたので月100GB、3,000円の格安SIM「Chat WiFi」をモバイルルーターに入れて使っていました。

で、この度古いですが平屋一戸建てに引っ越しまして、「新しいネット回線どうするか問題」がありました。

結果から言うとモバイルルーターは手放して、ワイモバイル契約してるとお得なソフトバンク光回線を契約しました。

で、更に「このソフトバンク光回線でどうやってwi-fi飛ばすか問題」が浮上しました。今まで住んでた10畳くらいの家だとルーター1つで良かったんですが、新しい平屋一戸建ては部屋が多くて壁が多いので「子機が必要かもな」という問題。

そこで、ちょうどPixel 4を買ったときにもらったGoogleストアで使える16,000円分のポイントがあったので、Googleの新しいwi-fiの形式「メッシュwi-fi」が飛ばせるNEST Wifiと拡張ポイントを購入しました。
...
あとは「OK Google、平日は7時に起こして」で目覚ましに使ってます。スマートスピーカーとしてしか使えないecho dotは引退です。
...
とりあえず「家に発信」という機能がよくわかりません。タップしたら拡張ポイントに電話がかけられるんですが、この機能何に使うんや…？
...
[NEST Wifi-Googleストア](https://store.google.com/jp/product/nest_wifi?hl=ja-JP)
